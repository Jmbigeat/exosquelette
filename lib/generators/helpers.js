...
import { hasNumbers, hasExternalization, hasDecisionMarkers, hasInfluenceMarkers, classifyCicatrice, extractBrickSummary } from "../sprint/analysis.js";
import { extractBrickCore, formatAnchorLine, formatCVLine as _formatCVLine, hasMentoringMarkers } from "../sprint/brickExtractor.js";
...
export var CV_ACTION_VERBS = ["Rattrapé", "Réduit", "Construit", "Lancé", "Restructuré", "Négocié", "Piloté", "Déployé", "Porté", "Augmenté"];
