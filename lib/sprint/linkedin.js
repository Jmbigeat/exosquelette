...
export function proposeSleepBrick(vault) {
  ...
  return {
    type: "passive_brick",
    suggestion: "En " + weeks + " semaines, tu as probablement vécu au moins 1 situation notable. Un problème résolu. Une décision prise. Un résultat mesuré. Ajoute-la à ton Coffre-Fort. L'IA la transforme en brique.",
    effort: "5 minutes",
  };
}
