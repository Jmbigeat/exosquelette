...
export var KPI_REFERENCE = {
  "enterprise_ae": {
    ...
    kpis: [
      ...
      { name: "Volume de Prospection", elasticity: "sous_pression", why: "L'IA produit déjà des séquences de mails. Zéro valeur ajoutée humaine ici." },
    ]
  },
  "head_of_growth": {
    role: "Head of Growth",
    ...
    kpis: [
      ...
      { name: "CPA (Coût par Acquisition)", elasticity: "sous_pression", why: "L'IA ajuste les enchères publicitaires mieux que n'importe quel humain." },
  ...
  "ai_architect": {
    ...
    kpis: [
      ...
      { name: "Taux d'Erreur (Hallucination)", elasticity: "stable", why: "Technique. Indispensable mais c'est du calibrage, pas de la stratégie." },
...
export var CAUCHEMAR_TEMPLATES_BY_ROLE = {
  ...
  head_of_growth: [
    ...
    { kpis: ["CPA (Coût par Acquisition)"], kw: ["cpa", "cout", "paid", "ads", "adwords", "facebook ads", "meta ads", "budget media", "roas", "roi"], label: "CPA qui explose", nightmare: "Le coût par lead a doublé en 6 mois. Le même budget produit 2x moins de clients.", cost: [100000, 400000], context: "Inflation publicitaire + saturation des canaux." },
...
export var ROLE_CLUSTERS = [
  ...
  { id: "fractional_coo", bloc: "Stratégie & Ops", label: "Direction / COO / Directeur de BU", subtitle: "Tu alignes des équipes, tu gères un P&L ou tu structures le temps de la direction ?", sectorLabel: "Direction" },
];
...
export var ROLE_PILLARS = {
  ...
  operations_manager: [
    ...
    { id: 2, title: "Simplifier est plus dur que construire", desc: "Pourquoi réduire la charge cognitive de 10 personnes vaut plus qu'accélérer 1 workflow." },
