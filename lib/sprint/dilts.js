...
export function detectDiltsLevel(text) {
  ...
  return { dominant: dominant, level: dominant, name: label.name, confidence: confidence, scores: scores, breakdown: breakdown };
}
...
export var DILTS_EDITORIAL_MAPPING = {
  2: { registre: "Ce que j'ai fait", sujets: "projet mené, résultat obtenu, situation gérée", brickTypes: ["chiffre", "cicatrice"], prospectPerception: "Le prospect enregistre un praticien." },
  3: { registre: "Comment je le fais", sujets: "méthode appliquée, framework utilisé, processus construit", brickTypes: ["chiffre", "decision"], prospectPerception: "Le prospect apprend de toi. Tu te distingues." },
  4: { registre: "Ce que je crois et pourquoi", sujets: "conviction née de l'expérience, désaccord avec le consensus", brickTypes: ["cicatrice", "decision"], prospectPerception: "Le prospect a une raison de se souvenir de toi. Tu occupes un territoire." },
  5: { registre: "Qui je suis dans cet écosystème", sujets: "rôle dans la conversation sectorielle, définition du métier", brickTypes: ["cicatrice", "decision"], prospectPerception: "Le prospect associe un problème à ton nom. Tu es le raccourci mental." },
};
