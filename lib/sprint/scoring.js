...
/* ─── V2 Blindage — 4 cases ─── */
function assessBrickArmor(brick) {
  ...
  var hasDecisionMarkers = ["décision", "decision", "arbitrage", "choix", "priorisé", "priorise", "tranché", "tranche", "recommandé", "recommande", "imposé", "impose", "validé", "valide", "convaincu", "négocié", "negocie"].some(function(m) { return text.indexOf(m) !== -1; });
  var hasInfluenceMarkers = ["équipe", "equipe", "collaborat", "mobilisé", "mobilise", "fédéré", "federe", "embarqué", "embarque", "aligné", "aligne", "convaincu", "présenté", "presente", "pitch", "sponsor", "stakeholder", "direction", "comité", "comite", "board"].some(function(m) { return text.indexOf(m) !== -1; });
  var hasTransferability = ["process", "méthode", "methode", "framework", "système", "systeme", "outil", "template", "playbook", "reproductible", "scalable", "structuré", "structure", "automatisé", "automatise", "industrialisé", "industrialise", "déployé", "deploye"].some(function(m) { return text.indexOf(m) !== -1; });
