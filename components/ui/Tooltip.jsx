    ...
    >
      <span
        ...
        style={{
          ...
          fontSize: 9, color: "#495670", cursor: "help",
          border: "1px solid #495670", borderRadius: "50%",
          width: 14, height: 14, textAlign: "center", lineHeight: "14px",
          userSelect: "none",
        }}
      >?</span>
      <span style={{
        position: "absolute", bottom: "calc(100% + 6px)", left: "50%", transform: "translateX(-50%)",
        background: "#0d0d1a", border: "1px solid #1a1a3e", color: "#ccd6f6",
        fontSize: 11, padding: "8px 12px", borderRadius: 6, maxWidth: 260,
        lineHeight: 1.5, zIndex: 100, whiteSpace: "normal",
