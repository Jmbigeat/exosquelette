...
export default function CookieBanner() {
  ...
  return (
    <div style={{
      ...
      background: "#111125", borderTop: "1px solid #1a1a3e",
      padding: "12px 24px", display: "flex", justifyContent: "space-between", alignItems: "center",
      boxSizing: "border-box", gap: 16, flexWrap: "wrap",
    }}>
      <div style={{ fontSize: 12, color: "#8892b0", lineHeight: 1.6 }}>
        ...
        <Link href="/confidentialite" style={{ color: "#4ecca3", textDecoration: "underline", fontSize: 12 }}>En savoir plus</Link>
      </div>
      <button onClick={accept} style={{
        background: "#e94560", color: "#f0f0ff", border: "none", padding: "6px 20px",
