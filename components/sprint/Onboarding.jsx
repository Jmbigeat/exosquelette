  ...
  return (
    <div style={{ padding: "20px 0" }}>
      ...
      <div style={{ background: "#0f3460", borderRadius: 12, padding: 16, marginBottom: 16 }}>
        <div style={{ fontSize: 12, color: "#e94560", fontWeight: 700, letterSpacing: 1, marginBottom: 12 }}>
          CE QUE L'OFFRE DEMANDE VRAIMENT
        </div>
        <div style={{ fontSize: 11, color: "#495670", marginBottom: 12 }}>
          Pas les compétences listées. Les cauchemars cachés derrière les mots.
        </div>
        {b1.cauchemars.map(function (c, i) {
          var kpiRef = roleData
            ? roleData.kpis.find(function (k) {
                return c.kpis && c.kpis.indexOf(k.name) !== -1;
              })
            : null;
          var eColor =
            kpiRef && kpiRef.elasticity === "élastique"
              ? "#4ecca3"
              : kpiRef && kpiRef.elasticity === "sous_pression"
                ? "#e94560"
                : "#8892b0";
          ...
          return (
            <div
              key={i}
              style={{
                borderBottom: i < 2 ? "1px solid #16213e" : "none",
            ...
            >
              ...
              <div style={{ fontSize: 10, color: "#e94560", fontWeight: 600 }}>
                Co{"û"}t : {costStr} / an
              </div>
            </div>
          );
        ...
        {b1.urgency > 0 && (
          <div style={{ marginTop: 8, fontSize: 10, color: "#e94560", fontWeight: 600 }}>
            {"\u26A1"} {b1.urgency} signaux d'urgence : {b1.urgencyHits.slice(0, 3).join(", ")}
          </div>
        )}
      </div>
      ...
      <div style={{ background: "#0f3460", borderRadius: 12, padding: 16, marginBottom: 16 }}>
        <div style={{ fontSize: 12, color: "#ff9800", fontWeight: 700, letterSpacing: 1, marginBottom: 12 }}>
          CE QUE TON CV DIT AU RECRUTEUR
        </div>
        {b2.perceptions.map(function (p, i) {
          var statusColor =
            p.status === "activite_chiffree" ? "#4ecca3" : p.status === "activite_sans_preuve" ? "#ff9800" : "#e94560";
          var statusIcon =
            p.status === "activite_chiffree"
              ? "\u26A0\uFE0F"
              : p.status === "activite_sans_preuve"
                ? "\u26A0\uFE0F"
                : "\u274C";
          return (
            <div
              key={i}
              style={{
                borderBottom: i < b2.perceptions.length - 1 ? "1px solid #16213e" : "none",
                paddingBottom: 8,
                marginBottom: 8,
              }}
            >
      ...
      >
        ...
        <div style={{ fontSize: 12, color: "#ccd6f6", lineHeight: 1.6, textAlign: "center" }}>
          Tu tires à blanc. Tu as l'expérience. Tu ne la formules pas en preuve. Le recruteur ne voit pas le remède. Il
          te jette.
        </div>
      </div>
      ...
      >
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 45%", background: "#1a1a2e", borderRadius: 6, padding: 8 }}>
            <div style={{ fontSize: 20, fontWeight: 800, color: "#e94560" }}>
      ...
      {b4.transformation && (
        <div style={{ background: "#0f3460", borderRadius: 12, padding: 16, marginBottom: 16 }}>
          <div style={{ fontSize: 12, color: "#4ecca3", fontWeight: 700, letterSpacing: 1, marginBottom: 12 }}>
            CE QUE LE SPRINT DÉBLOQUE
          </div>
          <div style={{ marginBottom: 12 }}>
            <div style={{ fontSize: 10, color: "#e94560", fontWeight: 700, marginBottom: 4 }}>
              AVANT — Ton CV aujourd'hui
            </div>
            <div
              style={{
                background: "#1a1a2e",
      ...
      {readiness && (
        <div
          style={{
            ...
            border:
              "1px solid " +
              (readiness.readiness === "fort" ? "#4ecca3" : readiness.readiness === "moyen" ? "#ff9800" : "#e94560"),
          }}
        >
          <div
            style={{
          ...
          >
            {readiness.readiness === "fort"
              ...
              : readiness.readiness === "moyen"
                ? "\u26A0\uFE0F"
                : "\uD83D\uDEA8"}{" "}
            GISEMENT : {readiness.estimatedBricks} briques extractibles
          </div>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {readiness.details.map(function (d, i) {
              return (
                <span key={i} style={{ fontSize: 10, color: d.ok ? "#4ecca3" : "#e94560" }}>
                  {d.ok ? "\u2714" : "\u2718"} {d.label}
                </span>
              );
            })}
      ...
      <button
        onClick={function () {
          ...
          b1.cauchemars.forEach(function (c) {
            lines.push(
              "- " +
                ...
                c.nightmareShort +
                " (cout : " +
                formatCost(c.costRange[0]) +
                " - " +
                formatCost(c.costRange[1]) +
                " / an)"
            );
          });
          lines.push("\nCE QUE TON CV DIT AU RECRUTEUR :");
          ...
          lines.push(
            b3.fossePct +
              "% de tes preuves sont invisibles. " +
              b3.totalCauchemars +
              " enjeux critiques, " +
              b3.coveredCount +
              " mentionnés, " +
          ...
          if (b4.transformation) {
            ...
            if (b4.transformation.isSimulated)
              lines.push("(Transformation simulée. La Forge extrait TES vrais chiffres.)");
          }
      ...
      <div style={{ fontSize: 11, color: "#495670", textAlign: "center" }}>
        Ta première munition en 20 minutes. Ton arsenal complet à ton rythme.
      </div>
    </div>
  );
}
...
export function Onboarding({ onStart, onScan }) {
      ...
      <div style={{ padding: "8px 0" }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: "#ccd6f6", marginBottom: 8 }}>
            Le marché ne paie pas la performance.
          </div>
          <div style={{ fontSize: 14, color: "#8892b0", lineHeight: 1.6, maxWidth: 400, margin: "0 auto" }}>
            Il paie la rareté. L'outil te montre où tu es rare, où tu es substituable, et comment inverser le rapport de
            force.
          </div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 20 }}>
          ...
          >
            ...
            <div style={{ fontSize: 16, fontWeight: 700, color: "#ccd6f6", marginBottom: 4 }}>
              Je vise un poste précis
            </div>
            <div style={{ fontSize: 13, color: "#8892b0", lineHeight: 1.5 }}>
              L'IA extrait les KPIs cachés, mesure l'élasticité du marché, et te dit où investir ton énergie.
            </div>
          </button>
          <button
            onClick={function () {
          ...
          >
            ...
            <div style={{ fontSize: 16, fontWeight: 700, color: "#ccd6f6", marginBottom: 4 }}>
              Je veux un diagnostic rapide
            </div>
            <div style={{ fontSize: 13, color: "#8892b0", lineHeight: 1.5 }}>
              L'IA scanne ton profil en 30 secondes. Tu vois ce que les recruteurs voient. Si ça te convainc, tu passes
              à la Forge.
            </div>
          </button>
        </div>
  ...
  if (phase === "ready") {
    ...
    var detectedCount = offerSignals
      ? offerSignals.cauchemars.filter(function (c) {
          return c.detected;
        }).length
      : 0;
    var scorePct = isPassif
      ? 28
      : offerSignals && offerSignals.totalSignals > 0
        ? Math.min(45, 20 + offerSignals.totalSignals * 3)
        : 32;
    var elasticCount = 0;
    if (targetRole && KPI_REFERENCE[targetRole]) {
      getActiveCauchemars().forEach(function (c) {
        var kpiMatch = KPI_REFERENCE[targetRole].kpis.find(function (k) {
          return c.kpis && c.kpis.indexOf(k.name) !== -1;
        });
    ...
    var subMsg = isPassif
      ...
      : detectedCount > 0
        ? detectedCount +
          ...
          (detectedCount > 1 ? "s" : "") +
          " dans ton offre." +
          (elasticCount > 0 ? " " + elasticCount + " sur marché élastique. C'est là que tu dois frapper." : "")
    ...
    return (
      <div style={{ padding: "32px 20px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          <div style={{ fontSize: 12, color: "#e94560", fontWeight: 700, letterSpacing: 2, marginBottom: 12 }}>
            {scoreLabel}
          </div>
        ...
        <div style={{ background: "#0f3460", borderRadius: 10, padding: 16, marginBottom: 16, textAlign: "left" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            <div style={{ fontSize: 12, color: "#e94560", fontWeight: 600, letterSpacing: 1 }}>
              {isPassif ? "CE QUE TU RATES" : "CAUCHEMARS DÉTECTÉS DANS L'OFFRE"}
            </div>
            {offerSignals && offerSignals.totalSignals > 0 && (
              <span
                style={{ fontSize: 10, color: "#4ecca3", background: "#1a1a2e", padding: "2px 8px", borderRadius: 8 }}
              >
                {offerSignals.totalSignals} signaux
              </span>
            )}
          </div>
          {getActiveCauchemars().map(function (c, i) {
            var kpiRef =
              targetRole && KPI_REFERENCE[targetRole]
                ? KPI_REFERENCE[targetRole].kpis.find(function (k) {
                    return c.kpis && c.kpis.indexOf(k.name) !== -1;
                  })
                : null;
            ...
            return (
              <div key={i} style={{ marginBottom: i < 2 ? 10 : 0 }}>
                <div style={{ display: "flex", gap: 6, alignItems: "center", marginBottom: 2 }}>
                  <span style={{ fontSize: 13, color: "#ccd6f6", fontWeight: 600 }}>
                    {"\uD83C\uDFAF"} {isPassif ? "Signal #" : "Cauchemar #"}
                    {i + 1} : {c.label}
                  </span>
                  {eText && (
                    <span
          ...
          {offerSignals && offerSignals.urgencyScore > 0 && (
            ...
            >
              {"\u26A1"} Signaux d'urgence détectés ({offerSignals.urgencyScore}) :{" "}
              {offerSignals.urgencyHits.slice(0, 3).join(", ")}
            </div>
          )}
        </div>
        ...
        {!isPassif && (
          ...
          >
            ...
            <div style={{ fontSize: 13, color: "#ccd6f6", fontWeight: 600, marginBottom: 6 }}>
              Estimation : {readiness.estimatedBricks} briques extractibles
              {readiness.estimatedCicatrices > 0 ? " + " + readiness.estimatedCicatrices + " cicatrice" : ""}
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 4, marginBottom: 8 }}>
              {readiness.details.map(function (d, i) {
                return (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    <span style={{ fontSize: 10, color: d.ok ? "#4ecca3" : "#e94560" }}>
                      {d.ok ? "\u2714" : "\u2718"}
                    </span>
          ...
          (function () {
            ...
            roleIds.forEach(function (rId) {
              ...
              rd.kpis.forEach(function (kpi) {
                ...
                words.forEach(function (w) {
                  if (cvLower.indexOf(w) !== -1) matchCount++;
                });
              });
            ...
            return (
              ...
              >
                ...
                <div style={{ fontSize: 11, color: "#8892b0", lineHeight: 1.5 }}>
                  Ton profil contient des signaux compatibles avec {best.role}. La Forge précisera si tes preuves
                  couvrent ce terrain mieux que{" "}
                  {KPI_REFERENCE[targetRole] ? KPI_REFERENCE[targetRole].role : "ton choix"}.
                </div>
              </div>
            );
          })()}
        ...
        {isPassif ? (
          <div style={{ textAlign: "center" }}>
            <div style={{ fontSize: 13, color: "#8892b0", marginBottom: 16, lineHeight: 1.6 }}>
              Voilà ce que les recruteurs voient. Si tu veux changer ça, la Forge extrait tes preuves cachées, construit
              ton arsenal et te positionne sur les terrains élastiques.
            </div>
            <button
              onClick={function () {
                setMode("actif");
            ...
            <div style={{ fontSize: 11, color: "#495670", marginTop: 10 }}>
              Le profil que tu as collé est déjà chargé. Ajoute tes offres cibles et choisis ton poste.
            </div>
          </div>
        ) : (
          <DiagnosticScreen
            ...
            return (
              <div
                ...
                style={{
                  ...
                  alignItems: "center",
                  gap: 10,
                  opacity: i === scanMessages.length - 1 ? 1 : 0.5,
  ...
  return (
    <div style={{ padding: "8px 0" }}>
      <div style={{ textAlign: "center", marginBottom: 28 }}>
        ...
        <div style={{ fontSize: 22, fontWeight: 800, color: "#ccd6f6", marginBottom: 8 }}>
          {isPassif
            ? "Ton profil est-il visible là où ça compte ?"
            : "Identifie où ta compétence rencontre la demande."}
        </div>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 12, color: "#8892b0", marginBottom: 8 }}>
          Colle ton CV, ta bio LinkedIn, ou décris ton dernier poste en quelques lignes.
        </div>
        <textarea
          value={cv}
          onChange={function (e) {
        ...
        <div
          style={{
            fontSize: 11,
            color: cv.trim().length > 20 ? "#495670" : "#e94560",
            marginTop: 4,
            textAlign: "right",
          }}
        >
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 700, color: "#ccd6f6" }}>
              Une offre qui t'intéresse (optionnel)
            </span>
          </div>
          <div style={{ fontSize: 12, color: "#8892b0", marginBottom: 8 }}>
            Colle 1 à 3 offres d'emploi, ou décris le poste que tu vises.
          </div>
          <textarea
            value={offers}
            onChange={function (e) {
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                  {blocs[blocName].map(function (cluster) {
                    ...
                    return (
                      ...
                      >
                        <div
                          style={{ fontSize: 12, fontWeight: 700, color: sel ? "#e94560" : "#ccd6f6", lineHeight: 1.3 }}
                        >
                          {cluster.label}
                        </div>
          ...
          {targetRole && (
            <div style={{ background: "#0f3460", borderRadius: 8, padding: 10, marginTop: 8 }}>
              ...
              {KPI_REFERENCE[targetRole].kpis.map(function (k, i) {
                var eColor =
                  k.elasticity === "élastique" ? "#4ecca3" : k.elasticity === "stable" ? "#8892b0" : "#e94560";
                var eLabel =
                  k.elasticity === "élastique" ? "↗\uFE0F" : k.elasticity === "stable" ? "↔\uFE0F" : "↘\uFE0F";
                return (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 3 }}>
                    <span style={{ fontSize: 10, color: eColor }}>{eLabel}</span>
                    <span style={{ fontSize: 11, color: "#ccd6f6" }}>{k.name}</span>
                    <span
                      style={{ fontSize: 9, color: eColor, background: "#1a1a2e", padding: "1px 6px", borderRadius: 6 }}
                    >
                      {k.elasticity === "élastique"
                        ? "élastique"
                        : k.elasticity === "stable"
                          ? "stable"
                          : "sous pression"}
              ...
              >
                ...
                <span style={{ fontSize: 11, color: "#ccd6f6" }}>
                  Rendez-vous de Souveraineté : {KPI_REFERENCE[targetRole].cadenceLabel}
                </span>
                <span style={{ fontSize: 9, color: "#495670" }}>({KPI_REFERENCE[targetRole].cadence}j)</span>
              </div>
              <div style={{ fontSize: 10, color: "#8892b0", marginTop: 4, lineHeight: 1.4 }}>
                {KPI_REFERENCE[targetRole].cadenceReason}
              </div>
            </div>
          )}
        </div>
      ...
      {canStart && (
        <div
          style={{
            background: "#3498db" + "12",
            borderRadius: 8,
            padding: 10,
            marginBottom: 12,
            border: "1px solid #3498db" + "33",
          }}
        >
          <div style={{ fontSize: 11, color: "#ccd6f6", lineHeight: 1.6 }}>
            <span style={{ fontWeight: 700, color: "#3498db" }}>
              {MARKET_DATA.ia_recrutement.tri_cv_par_ia}% des recruteurs
            </span>{" "}
            trient par algorithme. Un CV sans chiffre ancré ne passe plus le filtre. La Forge blinde tes preuves pour
            qu'elles résistent au tri IA.
          </div>
      ...
      <button
        ...
        style={{
          ...
          color: canStart ? "#fff" : "#495670",
          border: canStart ? "none" : "2px solid #16213e",
          borderRadius: 12,
      ...
      >
        {canStart ? (isPassif ? "Scanner ma visibilité" : "Lancer l'extraction") : "Remplis les champs pour commencer"}
      </button>
      <div style={{ fontSize: 11, color: "#495670", textAlign: "center", marginTop: 8 }}>
        Gratuit. Sans compte. Tes données ne sont pas stockées.
      </div>
