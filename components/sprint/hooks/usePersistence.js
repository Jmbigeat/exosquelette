...
export function usePersistence(stateSnapshot, onStateChange) {
  ...
  useEffect(
    function () {
      ...
      try {
        localStorage.setItem("sprint_state", JSON.stringify(stateObj));
      } catch (e) {}
    ...
    [
      stateSnapshot.screen,
      stateSnapshot.activeStep,
      stateSnapshot.bricks,
      stateSnapshot.vault,
      stateSnapshot.sprintDone,
      stateSnapshot.nextId,
      stateSnapshot.duelResults,
      stateSnapshot.targetRoleId,
      stateSnapshot.nightmareCosts,
      stateSnapshot.takes,
      stateSnapshot.parsedOffers,
      stateSnapshot.offersArray,
      stateSnapshot.offerNextId,
      stateSnapshot.aiPillarRecs,
      stateSnapshot.signature,
