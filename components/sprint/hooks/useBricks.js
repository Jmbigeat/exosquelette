...
export function useBricks(initialState, targetRoleId, offersArray) {
  ...
  return {
    bricks: bricks, setBricks: setBricks,
    vault: vault, setVault: setVault,
    takes: takes, setTakes: setTakes,
    nextId: nextId, setNextId: setNextId,
    toastBrick: toastBrick, setToastBrick: setToastBrick,
    navigateToBrick: navigateToBrick, setNavigateToBrick: setNavigateToBrick,
    handleForge: handleForge, handleCorrect: handleCorrect,
    handleMission: handleMission, handleSkip: handleSkip,
    handleAddBrick: handleAddBrick, handleBrickUpdate: handleBrickUpdate,
  };
}
