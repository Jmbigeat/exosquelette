...
var SCAN_MESSAGES_CV = ["Lecture de ton profil...", "Croisement profil × cauchemars...", "Diagnostic terminé."];
...
export function Eclaireur() {
      ...
      <div style={{ padding: "8px 0" }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: "#ccd6f6", marginBottom: 8 }}>
            Colle une offre. Je te montre ce que le recruteur cache.
          </div>
          <div style={{ fontSize: 14, color: "#8892b0", lineHeight: 1.6, maxWidth: 400, margin: "0 auto" }}>
            Gratuit. Pas de compte. 30 secondes.
          </div>
        </div>
        ...
        >
          {hasCv ? "Scanner l'offre × ton profil" : "Scanner l'offre"}
        </button>
      ...
      <div style={{ padding: "40px 20px" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 18, fontWeight: 700, color: "#ccd6f6" }}>
            {hasCv ? "Analyse de l'offre × ton profil" : "Analyse de l'offre en cours"}
          </div>
        </div>
        <div
          style={{
  ...
  if (phase === "result" && result) {
    ...
    var eColor =
      kpi && kpi.elasticity === "élastique"
        ? "#4ecca3"
        : kpi && kpi.elasticity === "sous_pression"
          ? "#e94560"
          : "#8892b0";
    var eLabel =
      kpi && kpi.elasticity === "élastique"
        ? "élastique"
        : kpi && kpi.elasticity === "stable"
          ? "stable"
          : kpi && kpi.elasticity === "sous_pression"
            ? "sous pression"
            : "";
    ...
    if (cvAudit) {
      if (cvScore === 5) {
        ctaText = "Ton CV couvre les 5 signaux. La Forge transforme tes preuves en livrables calibrés par canal.";
      } else if (cvScore >= 3) {
        ctaText = "Ton CV couvre une partie du problème. La Forge le calibre sur les cauchemars manquants.";
      } else {
        ctaText =
          "Ton CV ne répond pas à ce que le recruteur cherche. La Forge extrait tes vraies preuves et les formate.";
      }
    }
    ...
    return (
      <div style={{ padding: "8px 0" }}>
        <div style={{ textAlign: "center", marginBottom: 20 }}>
          ...
          <div style={{ fontSize: 10, color: "#495670", marginBottom: 4 }}>
            Rôle détecté : {result.detectedRoleLabel}
          </div>
        </div>
        ...
        <div style={{ background: "#0f3460", borderRadius: 12, padding: 16, marginBottom: 16 }}>
          ...
          {costStr && (
            <div style={{ fontSize: 12, color: "#e94560", fontWeight: 600, marginBottom: 12 }}>
              Coût du problème : {costStr}
            </div>
          )}
          ...
          {kpi && (
            <div style={{ borderTop: "1px solid #16213e", paddingTop: 10 }}>
              ...
              {kpi.elasticity === "élastique" &&
                ["enterprise_ae", "strategic_csm"].indexOf(result.detectedRoleId) !== -1 && (
                  <div style={{ fontSize: 11, color: "#4ecca3", fontStyle: "italic", marginTop: 6 }}>
                    62,8% des tâches commerciales sont automatisables (Anthropic, 2026). Pas celle-ci.
                  </div>
                )}
            </div>
          )}
        ...
        {!cvAudit && cvText.trim().length > 0 && cvText.trim().length < 100 && (
          <div style={{ background: "#0f3460", borderRadius: 12, padding: 16, marginBottom: 16 }}>
            <div style={{ fontSize: 12, color: "#8892b0", lineHeight: 1.6 }}>
              Ton texte est trop court pour un diagnostic fiable. Colle au moins 3 lignes de ton CV ou de ta bio
              LinkedIn.
            </div>
          </div>
        )}
        ...
        <div style={{ position: "relative", marginBottom: 20 }}>
          <div style={{ filter: "blur(6px)", userSelect: "none", pointerEvents: "none" }}>
            <div style={{ background: "#0f3460", borderRadius: 12, padding: 16, marginBottom: 8 }}>
              <div style={{ fontSize: 11, color: "#e94560", fontWeight: 700, letterSpacing: 1, marginBottom: 10 }}>
                3 AUTRES KPIS CACHÉS
              </div>
              <div style={{ marginBottom: 8 }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: "#ccd6f6", marginBottom: 2 }}>
                  Capacité de rétention des talents clés
                </div>
                <div style={{ fontSize: 11, color: "#8892b0" }}>
                  Le recruteur cherche quelqu'un qui empêche les départs en chaîne. Coût caché : 150K-400K / an.
                </div>
              </div>
              <div style={{ marginBottom: 8 }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: "#ccd6f6", marginBottom: 2 }}>
                  Vitesse d'exécution stratégique
                </div>
                <div style={{ fontSize: 11, color: "#8892b0" }}>
                  L'équipe produit des slides. Le board veut des résultats. Coût de l'inertie : 200K-600K / an.
                </div>
              </div>
              <div>
                <div style={{ fontSize: 13, fontWeight: 600, color: "#ccd6f6", marginBottom: 2 }}>
                ...
                <div style={{ fontSize: 11, color: "#8892b0" }}>
                  Trois départements travaillent en silo. Le projet avance trois fois moins vite que prévu.
                </div>
              </div>
            </div>
            <div style={{ background: "#0f3460", borderRadius: 12, padding: 16, marginBottom: 8 }}>
              <div style={{ fontSize: 11, color: "#e94560", fontWeight: 700, letterSpacing: 1, marginBottom: 10 }}>
                BRIQUES DE PREUVE RECOMMANDÉES
              </div>
              <div style={{ fontSize: 11, color: "#8892b0", lineHeight: 1.5 }}>
                4 briques identifiées dans ton profil. Chaque brique couvre un cauchemar spécifique et transforme ton CV
                en arsenal de négociation.
              </div>
            </div>
            <div style={{ display: "flex", gap: 8 }}>
              <div style={{ flex: 1, background: "#0f3460", borderRadius: 12, padding: 12 }}>
                ...
                <div style={{ fontSize: 11, color: "#8892b0" }}>
                  3 signaux d'urgence. Poste ouvert depuis 8 semaines.
                </div>
              </div>
              <div style={{ flex: 1, background: "#0f3460", borderRadius: 12, padding: 12 }}>
          ...
          >
            <div style={{ textAlign: "center", padding: 20 }}>
              <div style={{ fontSize: 14, fontWeight: 700, color: "#ccd6f6", marginBottom: 4 }}>
                Analyse complète verrouillée
              </div>
              <div style={{ fontSize: 12, color: "#8892b0" }}>
                La Forge débloque les 4 KPIs, les briques de preuve et la carte du marché.
              </div>
            </div>
          </div>
        </div>
