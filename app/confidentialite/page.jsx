  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 20px", minHeight: "100vh", background: "#06060f" }}>
      ...
      <div style={sectionStyle}>
        ...
        <p style={pStyle}>
          Email et mot de passe (hashé par Supabase). Collectées à la création du compte. Nécessaires au fonctionnement
          du service.
        </p>

        <h3 style={h3Style}>2. Données de la Forge</h3>
        <p style={pStyle}>
          Briques (textes saisis par le candidat), cauchemars couverts, score de densité, signature, livrables générés.
          Stockées dans Supabase. Liées au compte utilisateur.
        </p>
        ...
        <p style={pStyle}>
          Offre d'emploi collée et CV collé. <strong style={{ color: "#4ecca3" }}>NON STOCKÉES</strong>. Traitées en
          mémoire côté client. Supprimées à la fermeture de l'onglet. Aucune persistance serveur.
        </p>

        <h3 style={h3Style}>5. Données de paiement</h3>
        <p style={pStyle}>
          Traitées par Stripe. Abneg@tion ne stocke pas de numéro de carte. Seul l'identifiant client Stripe est
          conservé.
        </p>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        <p style={pStyle}>
          Les données sont collectées uniquement pour faire fonctionner le service : extraire les preuves de valeur du
          candidat, générer des livrables calibrés, et piloter la stratégie LinkedIn (Brew).
        </p>
        <p style={pStyle}>
          Aucune donnée n'est utilisée à des fins publicitaires. Aucune donnée n'est vendue à des tiers. Aucun profilage
          marketing.
        </p>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        <p style={pStyle}>
          Les données sont conservées tant que le compte est actif. À la suppression du compte, toutes les données sont
      ...
      <div style={sectionStyle}>
        ...
        <p style={{ ...pStyle, marginTop: 12 }}>
          Les transferts hors UE sont encadrés par les clauses contractuelles types (SCCs) de chaque sous-traitant.
        </p>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        <p style={pStyle}>
          ...
          <a href="https://www.cnil.fr" style={{ color: "#4ecca3" }}>
            CNIL
          </a>
          .
        </p>
      ...
      <div style={sectionStyle}>
        ...
        <p style={pStyle}>
          Le site utilise un cookie technique d'authentification (Supabase auth token). Ce cookie est nécessaire au
          fonctionnement du service. Il n'est pas utilisé pour le tracking.
        </p>
        <p style={pStyle}>
          Aucun cookie publicitaire. Aucun cookie analytics. Aucun pixel de tracking. Aucun outil tiers de mesure
          d'audience.
        </p>
      </div>
    </div>
