...
export default function MentionsLegalesPage() {
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 20px", minHeight: "100vh", background: "#06060f" }}>
      ...
      <h1 style={{ fontSize: 24, fontWeight: 800, color: "#e94560", fontFamily: "'JetBrains Mono', monospace", letterSpacing: 2, marginBottom: 40 }}>MENTIONS LÉGALES</h1>
      ...
      <div style={sectionStyle}>
        ...
        <p style={pStyle}><a href="https://vercel.com" style={{ color: "#4ecca3" }}>https://vercel.com</a></p>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        <p style={pStyle}><a href="https://supabase.com" style={{ color: "#4ecca3" }}>https://supabase.com</a></p>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        <p style={pStyle}>United States</p>
        <p style={pStyle}><a href="https://stripe.com" style={{ color: "#4ecca3" }}>https://stripe.com</a></p>
      </div>

      <div style={sectionStyle}>
        <h2 style={h2Style}>Propriété intellectuelle</h2>
        <p style={pStyle}>L'ensemble du contenu du site abnegation.eu (textes, code, design, méthodologie) est la propriété de Jean-Mikaël Bigeat. Toute reproduction sans autorisation est interdite.</p>
      </div>

      <div style={sectionStyle}>
        <h2 style={h2Style}>Données personnelles</h2>
        <p style={pStyle}>Voir la <Link href="/confidentialite" style={{ color: "#4ecca3", textDecoration: "underline" }}>Politique de confidentialité</Link>.</p>
      </div>
    </div>
  );
}
